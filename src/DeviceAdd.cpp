...
// 1. Reads new MAC addresses from the queue
// 2. Test to see if the addresses are rolling and sets appropriate flag
// 3. Looks in a rolling cache store to see if the macs have been seen before
// 4. Adds new found macs to the list of macs already found, date and lat/lon stamped
//-----------------------------------------------------------------------
